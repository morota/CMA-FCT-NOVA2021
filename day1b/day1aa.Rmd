...
.pull-left[
<iframe src="greenhouse-innovation-center.mp4" width="700" height="700" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
]
...
- Shiny genomic prediction accuracy simulator

- Genomic connectedness

- Factor analytic model 

- Longitudinal analysis & ShinyAIM

- variance heterogeneity association analysis (vQTL/vGWAS)
